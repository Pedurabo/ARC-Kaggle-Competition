...
class BreakthroughPredictor:
    ...
    def predict_task(self, task: Dict[str, Any]) -> List[Dict[str, List[List[int]]]]:
        ...
        for test_input in test_inputs:
            ...
            with torch.no_grad():
                task_tensor = torch.tensor(input_grid, dtype=torch.float).to(self.device)
...
# Run this cell to define the breakthrough models

# [Insert all the model classes here: AbstractReasoningModule, AdvancedMetaLearner, MultiModalReasoner, BreakthroughEnsemble]
"""
...
# Run this cell to generate the final submission
